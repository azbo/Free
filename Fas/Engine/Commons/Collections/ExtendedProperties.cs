...
namespace Commons.Collections
{
    ...
    public class ExtendedProperties : Hashtable
    {
        ...
        public new IEnumerable Keys => keysAsListed;
	    ...
	    */
        ...
        {
            bool b = GetBoolean(key, DEFAULT_BOOLEAN);
            if ((object)b == null)
            {
        ...
        {
            int i = GetInteger(key, DEFAULT_INT32);
            if ((object)i == null)
            {
                throw new Exception(string.Format("{0}{1}' doesn't map to an existing object", '\'', key));
            }
        ...
        {
            long l = GetLong(key, DEFAULT_INT64);
            if ((object)l == null)
            {
                throw new Exception(string.Format("{0}{1}' doesn't map to an existing object", '\'', key));
            }
        ...
        public long GetLong(string key, long defaultValue)
        {
            ...
            {
                long l = long.Parse((string)value);
        ...
        {
            float f = GetFloat(key, DEFAULT_SINGLE);
            if ((object)f == null)
            {
                throw new Exception(string.Format("{0}{1}' doesn't map to an existing object", '\'', key));
            }
        ...
        public float GetFloat(string key, float defaultValue)
        {
            ...
            else if (value is string)
            {
                ...
                float f = float.Parse((string)value);
