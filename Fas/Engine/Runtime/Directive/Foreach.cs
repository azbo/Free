...
namespace Fas.Tem.Runtime.Directive
{
    ...
    public class Foreach : Directive
    {
        ...
        static Foreach()
        {
            SectionNames = Enum.GetNames(typeof(ForeachSectionEnum));
    ...
    {
        public override ForeachSectionEnum Section => ForeachSectionEnum.Each;
    }

    public class ForeachBetweenSection : AbstractForeachSection
    {
        public override ForeachSectionEnum Section => ForeachSectionEnum.Between;
    }

    public class ForeachOddSection : AbstractForeachSection
    {
        public override ForeachSectionEnum Section => ForeachSectionEnum.Odd;
    }

    public class ForeachEvenSection : AbstractForeachSection
    {
        public override ForeachSectionEnum Section => ForeachSectionEnum.Even;
    }

    public class ForeachNoDataSection : AbstractForeachSection
    {
        public override ForeachSectionEnum Section => ForeachSectionEnum.NoData;
    }

    public class ForeachBeforeSection : AbstractForeachSection
    {
        public override ForeachSectionEnum Section => ForeachSectionEnum.Before;
    }

    public class ForeachAfterSection : AbstractForeachSection
    {
        public override ForeachSectionEnum Section => ForeachSectionEnum.After;
    }

    public class ForeachBeforeAllSection : AbstractForeachSection
    {
        public override ForeachSectionEnum Section => ForeachSectionEnum.BeforeAll;
    }

    public class ForeachAfterAllSection : AbstractForeachSection
    {
        public override ForeachSectionEnum Section => ForeachSectionEnum.AfterAll;
    }
}